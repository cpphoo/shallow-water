...
static inline void copy_subgrid(float *restrict dst,
...
static inline float xmin2s(float s, float a, float b)
{
...
static inline float limdiff(float um, float u0, float up)
{
...
static inline void limited_deriv1(float *restrict du,
...
static inline void limited_derivk(float *restrict du,
                                  const float *restrict u,
...
// Corrector
static void central2d_correct_sd(float *restrict s,
                                 float *restrict d,
...
static void central2d_step(float *restrict u, float *restrict v,
                           float *restrict scratch,
                           float *restrict f,
                           float *restrict g,
...
static int central2d_xrun(float *restrict u, float *restrict v,
                          float *restrict scratch,
                          float *restrict f,
                          float *restrict g,
